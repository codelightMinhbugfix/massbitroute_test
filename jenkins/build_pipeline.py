...
import os
components = {'component_name': 'api', 'repo_name': 'massbitroute', 'DEFAULT_COMPONENT_TAG_IN_BASE': 'export api=$(cat $RUNTIME_DIR/tags/API)', 'PR_COMPONENT_TAG_IN_BASE': 'export api=${PR_NUMBER}', 'jenkins_name': 'MassbitAPI'}
...
output = template.render(comps=components, stages=setup_stages, scenarios=scenarios)
print(output)
