...
files="network-docker-compose core-docker-compose portal-docker-compose fisherman-docker-compose"
for file in $files
do
  cat templates/${file}.yaml.template |  \
