...
export FISHERMAN_TAG=w3f-milestone-2
export STAKING_TAG=w3f-milestone-2
export PORTAL_TAG=w3f-milestone-2
export WEB_TAG=w3f-milestone-2
export MASSBIT_CHAIN_TAG=w3f-milestone-2
export API_TAG=w3f-milestone-2
export GIT_TAG=w3f-milestone-2
export GWMAN_TAG=w3f-milestone-2
export STAT_TAG=w3f-milestone-2
export MONITOR_TAG=w3f-milestone-2

export NODE_TAG=w3f-milestone-2
export GATEWAY_TAG=w3f-milestone-2
