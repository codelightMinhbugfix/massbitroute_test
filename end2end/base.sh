...
GATEWAY_TAG=$(cat latest_tag/GATEWAY_TAG)
NODE_TAG=$(cat latest_tag/NODE_TAG)
STAT_TAG=$(cat latest_tag/STAT_TAG)
MONITOR_TAG=$(cat latest_tag/MONITOR_TAG)
GIT_TAG=$(cat latest_tag/GIT_TAG)
MASSBIT_CHAIN_TAG=$(cat latest_tag/MASSBIT_CHAIN_TAG)
FISHERMAN_TAG=$(cat latest_tag/FISHERMAN_TAG)
STAKING_TAG=$(cat latest_tag/STAKING_TAG)
PORTAL_TAG=$(cat latest_tag/PORTAL_TAG)
WEB_TAG=$(cat latest_tag/WEB_TAG)
API_TAG=$(cat latest_tag/API_TAG)
GWMAN_TAG=$(cat latest_tag/GWMAN_TAG)
SESSION_TAG=$(cat latest_tag/SESSION_TAG)
